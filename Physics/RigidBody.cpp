...
RigidBody::RigidBody(ShapeType shapeID, glm::vec3 position, glm::vec2 velocity, float orientation, float mass)
{
	m_shapeID = shapeID;
	m_position = position;
	m_velocity = velocity;
...
void RigidBody::applyForce(glm::vec2 force)
{
	...
	RigidBody::m_velocity += force / RigidBody::getMass();
}
...
void RigidBody::applyForceToActor(RigidBody* actor2, glm::vec2 force)
{
	...
	actor2->applyForce(force); // Input actor
	this->applyForce(-force); // Current actor
}
