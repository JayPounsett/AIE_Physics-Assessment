...
public:
  ...
  virtual void drawBox(float xPos, float yPos, float width, float height,
  ...
  virtual void drawSpriteTransformed3x3(Texture *texture,
										float *transformMat3x3,
										float width = 0.0f, float height = 0.0f,
										float depth = 0.0f,
										float xOrigin = 0.5f,
										float yOrigin = 0.5f);
  virtual void drawSpriteTransformed4x4(Texture *texture,
...
protected:
  ...
  void rotateAround(float inX, float inY, float &outX, float &outY, float sin,
					float cos);
